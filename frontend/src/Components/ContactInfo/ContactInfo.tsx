...
const ContactInfo: FC<ContactInfoComp> = ({ info }) => {
  ...
  return (
    <Container>
      ...
      <Box mt={4} boxShadow={8} borderRadius={3} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <Box sx={{p: 2, display: 'flex', flexDirection: 'row', gap: '20px' }}>
          ...
          <Box sx={{ p: 2, display: 'flex', flexDirection: 'column', gap:'40px', }}>
            <Typography sx={{ display: 'flex', alignItems: 'center', gap: 1 }} fontSize='23px'>
              <Person4Icon />
            ...
            <Typography sx={{ display: 'flex', alignItems: 'center', gap: 1 }} fontSize='23px'>
              <EmailIcon />
              <strong>Second email:</strong> {info.secondEmail}
            </Typography>
          </Box>
