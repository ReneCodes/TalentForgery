...
const Dashboard = () => {
  ...
  return (
    <Container sx={{
      minHeight: '100vh', height: 'max-content', width: '100%', display: 'flex', gap: 4, flexDirection: 'column', justifyContent: 'start',
    }}>
      ...
      {peoplePending[0] &&
        < Box sx={{
          width: '100%', height: 'max-content', p: 2, display: 'flex',
          overflow: 'hidden', justifyContent: 'start',
          alignItems: 'start', gap: 4, borderRadius: 5, backgroundColor: '#fff5be',
          color: 'white'
        }}>
