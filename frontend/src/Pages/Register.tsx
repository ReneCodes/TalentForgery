		...
		<Container sx={{ height: { xs: 'max-content', sm: 'max-content', md: '100vh', }, py: 2 }}>
			...
			<Container sx={{ my: 3, py: 3, boxShadow: 10, borderRadius: 5 }}>
				...
				<form onSubmit={handleSubmit(handleRegister)} className="page">
					...
					<Stack spacing={1} width={'100%'} margin={'auto'}>

						<Box sx={
							{
								display: 'flex', flexDirection: { xs: 'column', sm: 'column', md: 'row' },
								justifyContent: 'center', alignItems: { xs: 'start', sm: 'center', md: 'center' }
							}
						}>
							...
							<Box display="flex" sx={{ m: { xs: 'auto', sm: 'auto', md: '-10px' }, order: { xs: '1', sm: '1', md: '2' } }}>

								<label htmlFor="profile_image">
									<ImageListItem sx={{ width: 100, height: 100, borderRadius: 999 }}>
										{file.name ? (
											<img style={{ width: '100px', height: '100px', borderRadius: '999px' }} src={URL.createObjectURL(file)} alt="" loading="lazy" />
										) : (
						...
						<Box sx={
							...
							<TextField
								...
								sx={{ width: { xs: '300px', sm: '300px', md: '470px' }, m: { xs: 'auto', sm: 'auto', md: 'auto 0 auto 40px' } }}
								label="Email"
								type="email"
								variant="standard"
								aria-label="name input-field"
							...
							<TextField
								...
								sx={{ width: { xs: '300px', sm: '300px', md: '470px' }, m: { xs: 'auto', sm: 'auto', md: 'auto 20px auto 0' } }}
								label="Department"
								variant="standard"
