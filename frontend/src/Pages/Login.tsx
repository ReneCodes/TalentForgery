...
import { Container, Input, Typography, TextField, FormControl, InputLabel, InputAdornment, IconButton, Button, Stack, FormHelperText, Box } from '@mui/material';
...
const Login: FC = () => {
	...
	return (
		...
		<Container
			sx={{ height: '100vh', width: '100%', overflow: 'hidden', py: 2 }}>
